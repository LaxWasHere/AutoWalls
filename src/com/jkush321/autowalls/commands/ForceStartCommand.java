...
public class ForceStartCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cmdSender, Command cmd, String label, String[] args) {
        ...
        {
            cmdSender.sendMessage(plugin.wprefix + ChatColor.GRAY + "There have to be at least 2 players, and the game can not be started yet, and the join timer must be over!");
        }
        return true;
    }
}
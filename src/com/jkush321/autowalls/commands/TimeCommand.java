...
public class TimeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender cmdSender, Command cmd, String label, String[] args) {
        ...
        {
            cmdSender.sendMessage(plugin.wprefix + ChatColor.GRAY + "The game hasn't started yet!"); return true;
        }
        ...
        cmdSender.sendMessage(plugin.wprefix + ChatColor.GRAY + "The walls will drop in " + minutes + " minutes and " + seconds + " seconds!");
        return true;
    }
}